...
Functions used for Hypothesis testing. TTEST supports classical
two-sample and paired t-tests, as well as method variants via via():
“boot” (bootstrap confidence interval) and “permute” (permutation test,
with a “rfast” engine backed by Rfast2).
