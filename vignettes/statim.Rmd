...
`prepare()` accepts any `STAT_FN` — `T_TEST`, `LINEAR_REG`, `CORTEST`, `P_TEST`, and so on. If you prefer to be explicit, `prepare_test()` and `prepare_model()` are available as typed alternatives.
