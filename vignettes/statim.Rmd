...
1.  Explicitness exists and enforced, because subjectively it makes the codes readable and maintainable. This is why the expression of null hypothesis inside `state_null()` is expressed as an algebraic expression. Strictness on how you type the code, as well.
