...
1.  [Hypothesis Testing with {statim}](./usage/htest.html)
2.  [Regression Modelling with {statim}](./usage/model-infer.html)
3.  [ANOVA models from Linear Models with {statim}](./usage/anova-mod.html)
