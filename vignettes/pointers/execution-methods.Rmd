...
|---|---|---|---|
| Define | `define_model()` | `def_model` | No |
| Prepare | `prepare_test()` | `test_lazy` | No |
| Prepare | `prepare_model()` | `model_lazy` | No |
| Recalibrate | `via()` | modified lazy object | No |
| Execute | `conclude()` | `cld_exec` | **Yes** |
| Tidy | `tidy()` | tibble | (reads `cld_exec@data`) |
| Print | `print()` | side effect | (reads `cld_exec@data`) |
