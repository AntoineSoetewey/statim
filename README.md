...
The philosophy: you declare *what* you want to infer. `{statim}` figures
out *how*.

## Overview

`{statim}` re-imagines the grammar of statistical inference in R. You
think about statistical statements:
